...
Download the latest `.deb` package from the [Releases](https://github.com/DasunSanching/msi-center-linux/releases) page:

```bash
# Download and install
wget https://github.com/DasunSanching/msi-center-linux/releases/download/v1.0.0/msi-center-linux_1.0.0_amd64.deb
sudo dpkg -i msi-center-linux_1.0.0_amd64.deb
```

Or download directly: **[msi-center-linux_1.0.0_amd64.deb](https://github.com/DasunSanching/msi-center-linux/releases/download/v1.0.0/msi-center-linux_1.0.0_amd64.deb)**
